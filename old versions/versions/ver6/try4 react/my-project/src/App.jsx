import { QuestionsLeftSection } from './components/QuestionsLeftSection/QuestionsLeftSection'
      ...
      <div>
        ...
        <div className="joint3-container1">
          <div className="joint3-thq-joint3-elm">
            ...
            {/* CmsText */}
            <CmsText
              field="herotitle"               // ключ поля в ACF (придумайте осмысленный)
              tag="span"
              className="joint3-thq-text-elm100"
              defaultValue="Свобода движения"     // запасной текст, если поле не заполнено
            />
            ...
            <div className="joint3-thq-frame277130167-elm">
              ...
              <CmsText
                field="hero_under_text"               // ключ поля в ACF (придумайте осмысленный)
                tag="span"
                className="joint3-thq-text-elm101"
                defaultValue="«Complex SW СУСТАВЫ» порошок для&nbsp;опорно-двигательного
                аппарата"     // запасной текст, если поле не заполнено
              />
            ...
            <div className="joint3-thq-frame277130166-elm">
              ...
              <CmsText
                field="hero_portion"               // ключ поля в ACF (придумайте осмысленный)
                tag="span"
                className="joint3-thq-text-elm103"
                defaultValue="1 порция = 17 обычных капсул
"
              />

              <CmsText
                field="hero_under_portion_text"               // ключ поля в ACF (придумайте осмысленный)
                tag="span"
                className="joint3-thq-text-elm104"
                defaultValue="Комплекс, который питает суставы изнутри и&nbsp;способствует
