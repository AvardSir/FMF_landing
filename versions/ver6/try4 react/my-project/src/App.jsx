      ...
      <div>
        ...
        <div className="joint3-container1">
          <div className="joint3-thq-joint3-elm">
            ...
            <div className="joint3-thq-frame277130167-elm">
              <span className="joint3-thq-text-elm101">
              ...
              <div className="joint3-thq-component4-elm1">
                <div className="joint3-thq-frame1060-elm1">
                  <div className="joint3-thq-tablerbasket-elm1">
                    <div className="joint3-thq-group-elm1"></div>
                  </div>
                </div>
                <div className="joint3-thq-frame5-elm1">
                  <span className="joint3-thq-text-elm102">Купить в 1 клик</span>
                </div>
                <div className="joint3-thq-frame1059-elm1">
                  <img alt="Frame1061I734" src="public/frame1061i734-zms.svg" className="joint3-thq-frame1061-elm1" />
                </div>
              </div> */}
            ...
            <div className="joint3-thq-frame277130166-elm">
              <span className="joint3-thq-text-elm103">
                1 порция = 17 обычных капсул
              </span>
              <span className="joint3-thq-text-elm104">
            ...
            <div className="joint3-thq-frame277130172-elm">
              ...
              <span className="joint3-thq-text-elm108">
            ...
            <div className="joint3-thq-frame277130181-elm">
              <span className="joint3-thq-text-elm122">
                1 порция = 17 обычных капсул
              </span>
              <span className="joint3-thq-text-elm123">
            ...
            <div className="joint3-thq-frame1082-elm">
              <div className="joint3-thq-frame277130187-elm">
                ...
                <span className="joint3-thq-text-elm125">
            ...
            <div className="joint3-thq-group6-elm">
              ...
              <div className="joint3-thq-frame277130174-elm">
                ...
                <div className="joint3-thq-frame65-elm">
                  <div className="joint3-thq-frame64-elm1">
                    <span className="joint3-thq-text-elm131">Глюкозамин</span>
                    <span className="joint3-thq-text-elm132">
                  ...
                  <div className="joint3-thq-frame57-elm">
                    <span className="joint3-thq-text-elm133">Хондроитин</span>
                    <span className="joint3-thq-text-elm134">
                  ...
                  <div className="joint3-thq-frame60-elm">
                    <span className="joint3-thq-text-elm135">МСМ</span>
                    <span className="joint3-thq-text-elm136">
                      Метилсульфонилметан укрепляет суставы, снимает воспаление и
                      боль, улучшает кожу, волосы, ногти и&nbsp;нормализует
                      иммунитет
                    </span>
                  </div>
                  <div className="joint3-thq-frame62-elm">
                    <span className="joint3-thq-text-elm137">Коллаген</span>
                    <span className="joint3-thq-text-elm138">
                      Является основным фибриллярным белком соединительной ткани,
                      обеспечивающим прочность и&nbsp;эластичность сухожилий,
                      костей и хрящей
                    </span>
                  </div>
                  <div className="joint3-thq-frame59-elm">
                    <span className="joint3-thq-text-elm139">Босвелия</span>
                    <span className="joint3-thq-text-elm140">
                  ...
                  <div className="joint3-thq-frame58-elm">
                    <span className="joint3-thq-text-elm141">Витамин С</span>
                    <span className="joint3-thq-text-elm142">
                  ...
                  <div className="joint3-thq-frame61-elm">
                    <span className="joint3-thq-text-elm143">Витамин Е</span>
                    <span className="joint3-thq-text-elm144">
                      Защищает суставы, замедляя разрушение хряща и&nbsp;уменьшая
                      боль и скованность
                    </span>
                  </div>
                  <div className="joint3-thq-frame63-elm">
                    <span className="joint3-thq-text-elm145">Марганец</span>
                    <span className="joint3-thq-text-elm146">
                      Необходим для работы центральной нервной системы, крепости
                      костей и жирового обмена
                    </span>
                  </div>
                  <div className="joint3-thq-frame66-elm">
                    <span className="joint3-thq-text-elm147">Селен</span>
                    <span className="joint3-thq-text-elm148">
            ...
            <span className="joint3-thq-text-elm150">
              <span>
            ...
            <div className="joint3-thq-frame277130186-elm">
              ...
              <span className="joint3-thq-text-elm155">
            ...
            <div className="joint3-thq-frame1111-elm">
              <div className="joint3-thq-frame1055-elm">
                ...
                <span className="joint3-thq-text-elm162">Все права защищены</span>
              </div>
            ...
            <div className="joint3-thq-group10-elm">
              ...
              <div className="joint3-thq-frame69-elm">
                ...
                <div className="joint3-thq-frame1057-elm">
                  <span className="joint3-thq-text-elm171">1 ложка в день</span>
                  <span className="joint3-thq-text-elm172">
                    Растворить в 200 мл воды
                  </span>
                  <span className="joint3-thq-text-elm173">Принимать утром</span>
                </div>
              </div>
            </div>
            <div className="joint3-thq-frame9-elm1">
              ...
              <div className="joint3-thq-frame1060-elm4">
                ...
                <div className="joint3-thq-frame10-elm">
                  <span className="joint3-thq-text-elm175">Состав</span>
                </div>
                <div className="joint3-thq-frame11-elm">
                  <span className="joint3-thq-text-elm176">Для кого</span>
                </div>
                <div className="joint3-thq-frame12-elm">
                  <span className="joint3-thq-text-elm177">Цена</span>
                </div>
...
<ActionButtonBlueMediumText/>
            ...
            <div className="joint3-thq-frame277130173-elm">
              ...
              <span className="joint3-thq-text-elm184">
...
<ActionButtonWhiteSmallText/>
            ...
            <div className="joint3-thq-frame277130182-elm">
              <div className="joint3-thq-frame277130180-elm">
                <span className="joint3-thq-text-elm186">Курс на 1 месяц</span>
                <span className="joint3-thq-text-elm187">
                          ...
                          <div className="joint3-thq-maxmessengerhorizontallogo1-elm">
                            <div className="joint3-thq-group-elm6">
                              <div className="joint3-thq-clippathgroup-elm1">
                                <div className="joint3-thq-svgid000000412575222465570809300000162176433937619-elm">
                                  <img alt="Vector7287" src="public/vector7287-vj3r.svg" className="joint3-thq-vector-elm6" />
                                </div>
                                <div className="joint3-thq-group-elm7">
                                  <div className="joint3-thq-clippathgroup-elm2">
                                    <div className="joint3-thq-svgid000000275732895343244076300000044975713446446-elm">
                                      <img alt="Vector7287" src="public/vector7287-lgce.svg"
                                        className="joint3-thq-vector-elm7" />
                                    </div>
                                    <div className="joint3-thq-group-elm8">
                                      <div className="joint3-thq-clippathgroup-elm3">
                                        <div className="joint3-thq-svgid000001817935301781070939000000160947296855471-elm">
